OC.L10N.register(
    ...
    "👥 Allows for better collaboration with external users by allowing users to create guests account.\n\nGuests accounts can be created from the share menu by entering either the recipients email or name and choosing \"create guest account\", once the share is created the guest user will receive an email notification about the mail with a link to set their password.\n\nGuests users can only access files shared to them and can't create any files outside of shares, additionally, the apps accessible to guest accounts are whitelisted." : "Umožňuje lepší spolupráci s uživateli zvenčí tím, že si mohou vytvářet účet hosta.\n\nÚčty hostů je možné vytvářet z nabídky sdílení zadáním buď e-mailu příjemce nebo jména a volbou „vytvořit účet hosta\". Jakmile je sdílení vytvořeno, uživatel-host o tom obdrží upozornění e-mailem společně s odkazem pro nastavení svého hesla.\n\nUživatelé-hosté mohou přistupovat pouze k souborům, které jsou jim nasdíleny a nemohou vytvářet žádné soubory mimo sdílení. Dále, aplikace přístupné účtům hostů jsou jsou řízeny seznamem povolených.",
    "None" : "Žádné",
    "Name" : "Jméno",
    "Shared By" : "Sdílí",
    "Shared At" : "Sdíleno v",
    ...
    "Save and create share" : "Uložit a vytvořit sdílení",
    "Create guest account for {name}" : "Vytvořit účet hosta pro {name}",
    ...
    "Only group admins are allowed to create guests and guests must be added to at least one group the share creator is a group admin for." : "Účty pro hosty mohou vytvářet pouze správci skupiny a hosty je třeba přidat do alespoň jedné ze skupiny, které je tvůrce sdílení správcem.",
    ...
    "Guests will still be able to see users from any group they are added to" : "Hosté i tak budou moci vidět uživatele ze skupiny, do které jsou přidáni",
    ...
    "Saving …" : "Ukládání…",
    "Create guest account" : "Vytvořit účet pro hosta"
},
