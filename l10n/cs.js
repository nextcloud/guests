OC.L10N.register(
    "guests",
    {
    "Access to this resource is forbidden for guests." : "Přístup k tomuto prostředku je pro hosty zakázán.",
    ...
    "User is not a guest" : "Uživatel není host",
    ...
    "Hey there," : "Zdravíme,",
    "%1$s just invited you and shared »%2$s« with you." : "%1$s vás právě pozval/a a nasdílel/a vám „%2$s“.",
    ...
    "%s invited you as a guest" : "%s vás pozval/a jako hosta",
    "You have been invited" : "Byli jste pozváni",
    "%s just invited you." : "%s vás právě pozval/a.",
    "You can activate your guest account with the button below." : "Svůj účet hosta můžete aktivovat níže uvedeným tlačítkem.",
    "After your account is activated you can log in with %s." : "Po aktivaci vašeho účtu se můžete přihlásit pomocí %s.",
    "Guests" : "Hosté",
    ...
    "Guest conversion done" : "Převod hosta dokončen",
    "Conversion of guest {guest} to {user} completed" : "Převedení hosta {guest} na {user} dokončeno",
    ...
    "Name" : "Název",
    "Shared By" : "Sdílí",
    "Shared At" : "Sdíleno na",
    "Guest accounts" : "Účty hostů",
    "Email" : "E-mail",
    ...
    "Default" : "Výchozí",
    "Conversion of guest {strongStart}{guest}{strongEnd} to {strongStart}{user}{strongEnd} is pending" : "Převod hosta {strongStart}{guest}{strongEnd} to {strongStart}{user}{strongEnd} čeká",
    "Conversion of guest {strongStart}{guest}{strongEnd} to {strongStart}{user}{strongEnd} has started" : "Převod hosta {strongStart}{guest}{strongEnd} to {strongStart}{user}{strongEnd} započal",
    ...
    "Guests are accounts with limited permissions who will be able to access resources shared with them and use apps." : "Hosté jsou účty s omezenými oprávněními kteří budou schopní přistupovat k prostředkům, které jsou jim nasdílené a používat aplikace.",
    ...
    "Saving …" : "Ukládání …",
    "The admin group is always allowed to create guest accounts" : "Skupině admin (správci) je vytváření účtů hostů povoleno vždy",
    "Guest accounts are grouped under a virtual group in the account manager" : "Účty hostů jsou seskupeny v rámci virtuální skupiny ve správě účtů",
    "Guests are simple, limited accounts you can give to people outside your Nextcloud instance." : "Hosté jsou jednoduché, omezené účty které je možné dávat lidem mimo vaší Nextcloud instanci.",
    "They do not get their own storage, but can log in and work together on files, folders and chats you share with them." : "Nezískají své vlastí úložiště, ale mohou se přihlašovat a pracovat společně na souborech, složkách a chatech, které jim nasdílíte.",
    "Guests are always identified as such, to make it clear who is part of your team and who is an external collaborator." : "Hosté jsou vždy identifikovaní jako hosté, aby bylo jasné, kdo je ve vašem týmu a kdo je externí spolupracovník.",
    "Use them when you want to collaborate with friends, clients or partners without having to create full user accounts." : "Použijte pokud chcete spolupracovat s přáteli, klienty nebo partnery, aniž by bylo třeba jim vytvářet plné uživatelské účty.",
    "Creating guests accounts is restricted while \"Restrict accounts to only share with accounts in their groups\" is enabled." : "Vytváření účtů hostů je omezeno, pokud je zapnuté „Povolit sdílení pouze mezi účty v rámci jejich skupin“.",
    ...
    "Guest accounts can access mounted external storages" : "Účty hostů mohou přistupovat k připojeným externím úložištím",
    "Hide other accounts from guests" : "Skrýt před hosty ostatní uživatelské účty",
    "Guests will still be able to see accounts from any group they are added to" : "Hosté i tak budou moci vidět účty ze skupin, do kterých jsou přidáni",
