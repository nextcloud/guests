OC.L10N.register(
    ...
    "Hey there," : "Salude,",
    "%s just shared »%s« with you." : "%s at cumpartzidu »%s« cun tegus.",
    ...
    "Guest users are grouped under a virtual group in the user manager" : "Is persones invitadas sunt agrupadas in unu grupu virtuale in sa gestione de utentes",
    "Guest users can access mounted external storages" : "Is utèntzias invitadas podent intrare in is archiviatziones de foras montadas",
    "Hide other users from guests" : "Cua dae àteras persones invitadas",
    "Guests will still be able to see users from any group they are added to" : "Is persones invitadas ant a pòdere bìdere is utentes de cale si siat grupu a su chi siant agiuntas",
    "Limit guest access to an app whitelist" : "Lìmita s'atzessu de persones invitadas a una lista de permissos de aplicatzione",
