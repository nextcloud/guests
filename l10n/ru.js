OC.L10N.register(
    ...
    "Hey there,<br><br>\n         \n         just letting you know that %s shared <strong>%s</strong> with you.<br><br>\n         Activate your guest account at %s by <a href=\"%s\">setting a password</a>.<br><br>\n         Then <a href=\"%s\">view it!</a><br><br>You can login using the email address <strong>\"%s\"</strong> .<br><br>" : "Привет,<br><br>\n\nИмейте в виду, что %s поделился <strong>%s</strong> с вами.<br><br>\nАктивируйте вашу гостевую учётную запись в %s <a href=\"%s\">установив пароль</a>.<br><br>\nПотом <a href=\"%s\">посмотрите это!</a><br><br>Вы можете авторизоваться, используя адрес эл. почты <strong>\"%s\"</strong> .<br><br>",
