OC.L10N.register(
    ...
    "Creating guests accoutns is restricted while \"Restrict accounts to only share with accounts in their groups\" is enabled." : "Създаването на профили за гости е ограничено, докато е активирано „Ограничаване на профилите да споделят само с профили в техните групи“.",
    ...
    "Limit guest access to an app allowlist" : "Ограничен достъп на гостите до списъка с разрешени приложения",
