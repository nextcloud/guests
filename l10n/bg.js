OC.L10N.register(
    ...
    "Guest users are grouped under a virtual group in the user manager" : "Гост потребителите са групирани във виртуална група в потребителския мениджър",
    "Guest users can access mounted external storages" : "Гост потребителите, имат достъп до монтирани външни хранилища",
    "Hide other users from guests" : "Скриване на другите потребители от гостите",
    "Guests will still be able to see users from any group they are added to" : "Гостите все още ще могат да виждат потребители от всяка група, към която са добавени",
    "Limit guest access to an app whitelist" : "Ограничаване на достъпа на гостите до белия списък с приложения",
