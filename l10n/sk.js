OC.L10N.register(
    "guests",
    {
    "Access to this resource (%s) is forbidden for guests." : "Prístup k tomuto zdroju (%s) je hosťom zakázaný.",
    ...
    "Only accounts that have never logged in can be converted" : "Konvertovať možno iba účty, ktoré sa nikdy neprihlásili",
    "Accounts with administrative privileges cannot be converted to guests" : "Účty s oprávneniami správcu nemožno konvertovať na hosťovské účty",
    "An error occurred while converting the account" : "Pri konverzii účtu sa vyskytla chyba",
    "%s via %s" : "%s cez %s",
    ...
    "%s shared a file with you" : "%s zdieľal súbor s vami",
    "Hey there," : "Zdravím,",
    "%1$s just invited you and shared »%2$s« with you." : "%1$s vás práve pozval a zdieľal s vami »%2$s«.",
    ...
    "%s invited you as a guest" : "%s vás pozval ako hosťa",
    "You have been invited" : "Bol/a si pozvaný/á",
    "%s just invited you." : "%s ťa práve pozval.",
    "You can activate your guest account with the button below." : "Môžete aktivovať svoj hosťovský účet pomocou tlačidla nižšie.",
    "After your account is activated you can log in with %s." : "Po aktivácii vášho účtu sa môžete prihlásiť pomocou %s.",
    "Guests" : "Hostia",
    ...
    "Convert to guest account" : "Konvertovať na hosťovský účet",
    "The account \"{userId}\" will be converted into a guest account. It keeps its login name and password but becomes a limited guest account, restricted to the apps allowed for guests." : "Účet „{userId}“ bude konvertovaný na hosťovský účet. Zachová si prihlasovacie meno a heslo, ale stane sa obmedzeným hosťovským účtom s prístupom iba k aplikáciám povoleným pre hostí.",
    "This is only possible for accounts that have never logged in. It cannot be undone automatically." : "Toto je možné iba pri účtoch, ktoré sa nikdy neprihlásili. Konverziu nie je možné automaticky vrátiť späť.",
    "Cancel" : "Zrušiť",
    "Converting account…" : "Prebieha konverzia účtu…",
    "Convert to guest" : "Konvertovať na hosťa",
    "None" : "Žiadne",
    "Name" : "Názov",
    "Shared By" : "Zdieľa",
    "Shared At" : "Zdieľané v",
    "An error occurred while fetching the shares list" : "Pri načítaní zoznamu zdieľaní nastala chyba",
    "Guest accounts" : "Účty návštevníkov",
    "Email" : "E-mail",
    ...
    "An error occurred while converting the guest" : "Počas konverzie hosťa došlo k chybe",
    ...
    "Default quota ({size})" : "Predvolená kvóta ({size})",
    "Unlimited" : "Neobmedzené",
    "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"" : "Prosím zadajte kvótu s jednotkou, napríklad „500 MB“ alebo „2 GB“.",
    "Error" : "Chyba",
    ...
    "Guests are simple, limited accounts you can give to people outside your Nextcloud instance." : "Hostia sú jednoduché, obmedzené účty, ktoré môžete poskytnúť ľuďom mimo vašej inštancie Nextcloud.",
    "They do not get their own storage, but can log in and work together on files, folders and chats you share with them." : "Nemajú vlastné úložisko, ale môžu sa prihlásiť a spolupracovať na súboroch, priečinkoch a chatoch, ktoré s nimi zdieľate.",
    "Guests are always identified as such, to make it clear who is part of your team and who is an external collaborator." : "Hostia sú vždy identifikovaní ako takí, aby bolo jasné, kto je súčasťou vášho tímu a kto je externý spolupracovník.",
    "Use them when you want to collaborate with friends, clients or partners without having to create full user accounts." : "Použite ich, keď chcete spolupracovať s priateľmi, klientmi alebo partnermi, bez potreby vytvárať úplné používateľské účty.",
    ...
    "Use a hash of the email as user ID for improved privacy" : "Použite hash e-mailu ako používateľské ID pre zvýšené súkromie",
    ...
    "No apps selected" : "Neboli vybrané žiadne aplikácie",
    "Edit allowlist" : "Upraviť zoznam povolených",
    "Confirm allowlist" : "Potvrdiť zoznam povolených",
    "Reset allowlist" : "Resetovať zoznam povolených aplikácií",
    "Default quota for new guest accounts" : "Predvolená kvóta pre nové hosťovské účty",
    ...
    "Account \"{userId}\" was converted into a guest account" : "Účet „{userId}“ bol konvertovaný na hosťovský účet"
},
