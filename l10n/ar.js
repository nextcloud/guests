OC.L10N.register(
    ...
    "Invalid mail address" : "عنوان الإيميل غير صحيح",
    ...
    "Hey there," : "مرحبا، ",
    "%s just shared »%s« with you." : "%s قام للتوِّ بٌمشاركة «%s» معك.",
    ...
    "Invite user and create share" : "أُدعّ مستخدماً و أنشيء مُشاركةً",
    "Guest user needs to be added to at least one group" : "المُستخدمُ الضيفُ يجب أن يُضاف إلى مجموعةٍ و احدةٍ على الأقل",
    "Guest accounts are grouped under a virtual group in the account manager" : "يتم تجميع حسابات الضيوف في مجموعة افتراضية في مُدير الحسابات account manager.",
