OC.L10N.register(
    ...
    "After your account is activated you can view the share by logging in with %s." : "賬戶啟用後，您就能登入 %s 檢視分享項目了。",
    "The share will expire at %s." : "此分享將於 %s 過期。",
    "Activate account" : "啟用賬戶",
    "View share" : "檢視分享",
    "%s via %s" : "%s 經由 %s",
    ...
    "Guest users are grouped under a virtual group in the user manager" : "訪客用戶的群組在用戶管理者的虛擬群組之下",
