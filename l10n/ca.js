OC.L10N.register(
    ...
    "Save and create share" : "Desa i crea la compartició",
    "Create guest account for {name}" : "Crea un compte convidat per a {name} ",
    ...
    "Create guest account" : "Crea un compte convidat"
},
