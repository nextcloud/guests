OC.L10N.register(
    "guests",
    {
    "Access to this resource (%s) is forbidden for guests." : "Tá cosc ​​ar rochtain ar an acmhainn seo (%s) d'aíonna.",
    ...
    "An error occurred while fetching the shares list" : "Tharla earráid agus an liosta scaireanna á fháil",
    "Guest accounts" : "Cuntais aoi",
    "Email" : "Ríomhphost",
    ...
    "An error occurred while converting the guest" : "Tharla earráid agus an t-aoi á thiontú",
    ...
    "Invite guest" : "Tabhair cuireadh do aoi",
    "Default quota ({size})" : "Cuóta réamhshocraithe ({size})",
    "Unlimited" : "Gan teorainn",
    "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"" : "Cuir isteach cuóta le haonad, mar shampla \"500 MB\" nó \"2 GB\"",
    "Error" : "Earráid",
    ...
    "No apps selected" : "Níl aon aipeanna roghnaithe",
    "Edit allowlist" : "Cuir an liosta ceadanna in eagar",
    "Confirm allowlist" : "Deimhnigh an liosta ceadanna",
