OC.L10N.register(
    ...
    "Guests are accounts with limited permissions who will be able to access resources shared with them and use apps." : "Les comptes Invités peuvent accéder aux ressources partagées avec eux et aux applications définis par l'administrateur.",
    "Language" : "Langue",
    "Add guest to groups:" : "Ajouter cet invité aux groupes :",
    ...
    "They do not get their own storage, but can log in and work together on files, folders and chats you share with them." : "Ils ne disposent pas de leur propre espace de stockage, mais peuvent se connecter et travailler ensemble sur les fichiers, dossiers et discussions que vous partagez avec eux.",
    ...
    "Creating guests accounts is restricted while \"Restrict accounts to only share with accounts in their groups\" is enabled." : "La création de comptes d'invités est restreinte lorsque l'option \"N'autoriser les partages qu'entre membres de mêmes groupes\" est activée.",
    ...
    "Hide other accounts from guests" : "Masquer les autres comptes des invités",
