OC.L10N.register(
    ...
    "%s just invited you and shared »%s« with you." : "%s vous invite et vient de partager %s avec vous",
    ...
    "Guests account have no quota by default" : "Les comptes invités n'ont pas de quota par défaut",
