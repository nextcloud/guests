OC.L10N.register(
    ...
    "Account is already a guest" : "Account is already a guest",
    "Only regular accounts can be converted to guests" : "Only regular accounts can be converted to guests",
    "Only accounts that have never logged in can be converted" : "Only accounts that have never logged in can be converted",
    "Accounts with administrative privileges cannot be converted to guests" : "Accounts with administrative privileges cannot be converted to guests",
    "An error occurred while converting the account" : "An error occurred while converting the account",
    "%s via %s" : "%s via %s",
    ...
    "Convert to guest account" : "Convert to guest account",
    "The account \"{userId}\" will be converted into a guest account. It keeps its login name and password but becomes a limited guest account, restricted to the apps allowed for guests." : "The account \"{userId}\" will be converted into a guest account. It keeps its login name and password but becomes a limited guest account, restricted to the apps allowed for guests.",
    "This is only possible for accounts that have never logged in. It cannot be undone automatically." : "This is only possible for accounts that have never logged in. It cannot be undone automatically.",
    "Cancel" : "Cancel",
    "Converting account…" : "Converting account…",
    "Convert to guest" : "Convert to guest",
    "None" : "None",
    "Name" : "Surname",
    "Shared By" : "Shared By",
    "Shared At" : "Shared At",
    "An error occurred while fetching the shares list" : "An error occurred while fetching the shares list",
    ...
    "An error occurred while converting the guest" : "An error occurred while converting the guest",
    ...
    "Invite guest" : "Invite guest",
    "Default quota ({size})" : "Default quota ({size})",
    "Unlimited" : "Unlimited",
    "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"" : "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"",
    "Error" : "Error",
    ...
    "Use a hash of the email as user ID for improved privacy" : "Use a hash of the email as user ID for improved privacy",
    ...
    "Confirm allowlist" : "Confirm allowlist",
    "Reset allowlist" : "Reset allowlist",
    "Default quota for new guest accounts" : "Default quota for new guest accounts",
    "Add guest" : "Add guest",
    ...
    "Account \"{userId}\" was converted into a guest account" : "Account \"{userId}\" was converted into a guest account"
},
