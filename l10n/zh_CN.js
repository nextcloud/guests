OC.L10N.register(
    ...
    "Cheers!" : "干杯！",
    "Hey there,<br><br>\n         \n         just letting you know that %s shared <strong>%s</strong> with you.<br><br>\n         Activate your guest account at %s by <a href=\"%s\">setting a password</a>.<br><br>\n         Then <a href=\"%s\">view it!</a><br><br>You can login using the email address <strong>\"%s\"</strong> .<br><br>" : "(｡･∀･)ﾉﾞ嗨,<br><br>\n\n给你说一下 %s 共享了 <strong>%s</strong> 给你.<br><br>\n在 %s 通过 <a href=\"%s\"> 激活你的访客账号并设置一个密码 </a>.<br><br>\n然后 <a href=\"%s\"> 查看文件吧! </a><br><br> 你可以使用这个邮箱地址来登陆 <strong>\"%s\"</strong>.\n<br><br>",
