OC.L10N.register(
    ...
    "Guest does not exist" : "Vierasta ei ole olemassa",
    "User already exists" : "Käyttäjä on jo olemassa",
    "User is not a guest" : "Käyttäjä ei ole vieras",
    ...
    "Hey there," : "Hei vaan,",
    "%1$s just invited you and shared »%2$s« with you." : "%1$s kutsui sinut juuri ja jakoi »%2$s« kanssasi.",
    ...
    "%s invited you as a guest" : "%s kutsui sinut vieraaksi",
    "You have been invited" : "Sinut on kutsuttu.",
    "%s just invited you." : "%s kutsui sinut juuri.",
    "Guests" : "Vieraat",
    "Data imported" : "Tiedot tuotu",
    "Data from your previous guest account was successfully imported into your new account." : "Tiedot aiemmasta vierastilistäsi tuotiin onnistuneesti uuteen tiliisi.",
    "Guest conversion failed" : "Vieraan muunnos epäonnistui",
    "Guest conversion done" : "Vieraan muunnos valmistui",
    ...
    "Default" : "Oletus",
    "Convert guest to regular account" : "Muuta vierastili tavalliseksi tiliksi",
    "New account name" : "Uuden tilin nimi",
    "Cancel" : "Peruuta",
    "Converting guest…" : "Muunnetaan vierasta…",
    "Convert" : "Muunna",
    ...
    "Saving …" : "Tallennetaan …",
    "Guest accounts can access mounted external storages" : "Vierastileillä on pääsy liitetyille erillisiin tallennustiloihin",
    "Hide other accounts from guests" : "Piilota muut tilit vierailta",
