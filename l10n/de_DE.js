OC.L10N.register(
    "guests",
    {
    "Access to this resource (%s) is forbidden for guests." : "Der Zugriff auf diese Ressource (%s) ist für Gäste untersagt. ",
    ...
    "An error occurred while fetching the shares list" : "Beim Abruf der Freigabeliste ist ein Fehler aufgetreten",
    "Guest accounts" : "Gastkonten",
    "Email" : "E-Mail",
    "User ID" : "Benutzer-ID",
    ...
    "An error occurred while converting the guest" : "Beim Konvertieren des Gastes ist ein Fehler aufgetreten",
    ...
    "Invite guest" : "Gast einladen",
    "Default quota ({size})" : "Standard Speicherkontingent ({size})",
    "Unlimited" : "Unbegrenzt",
    "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"" : "Bitte ein Kontingent mit einer Einheit eingeben, zum Beispiel \"500 MB\" oder \"2 GB\".",
    "Error" : "Fehler",
    ...
    "Edit allowlist" : "Erlaubnisliste bearbeiten",
    "Confirm allowlist" : "Erlaubnisliste bestätigen",
