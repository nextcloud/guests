OC.L10N.register(
    ...
    "Failed to convert guest {guest} account to {user} account" : "Das Gastkonto {guest} konnte nicht in ein {user}-Konto geändert werden.",
    "Guest conversion done" : "Konvertierung des Gastkontos abgeschlossen",
    "Conversion of guest {guest} to {user} completed" : "Konvertierung von Gast {guest} in {user} abgeschlossen",
    ...
    "Default" : "Standard",
    "Convert guest to regular account" : "Gastkonto in einreguläres Konto konvertieren",
    ...
    "Guest will be converted to a regular account with the account name \"{userId}\" soon" : "Der Gastkonto wird in Kürze in ein reguläres Konto mit dem Namen \"{userId}\" konvertiert",
