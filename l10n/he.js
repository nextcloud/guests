OC.L10N.register(
    ...
    "Save and create share" : "שמירה ויצירת שיתוף",
    "Create guest account for {name}" : "יצירת חשבון אורח עבור {name}",
    ...
    "Guest users can access mounted external storages" : "משתמשים אורחים יכולים לגשת לאמצעי אחסון חיצוניים מעוגנים",
    "Hide other users from guests" : "הסתרת המשתמשים האחרים מפני האורחים",
    "Guests will still be able to see users from any group they are added to" : "אורחים עדיין יוכלו לראות משתמשים מכל קבוצה שאליה נוספו",
    ...
    "Saving …" : "מתבצע שמירה…",
    "Create guest account" : "יצירת חשבון אורח"
},
