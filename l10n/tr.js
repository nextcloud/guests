OC.L10N.register(
    ...
    "Data from your previous guest account was successfully imported into your new account." : "Daha önceki misafir hesabınızdaki veriler yeni hesabınıza başarılı bir şekilde aktarıldı.",
    ...
    "Save and create share" : "Kaydedip paylaşımı oluştur",
    "Create guest account for {name}" : "{name} için konuk hesabı ekle",
