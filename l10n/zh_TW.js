OC.L10N.register(
    ...
    "Creating guests accoutns is restricted while \"Restrict accounts to only share with accounts in their groups\" is enabled." : "啟用「限制帳號只能分享給群組裡的其他帳號」時，會限制訪客帳號的建立。",
    ...
    "Limit guest access to an app allowlist" : "允許清單限制訪客存取部分應用程式",
