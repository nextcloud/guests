OC.L10N.register(
    "guests",
    {
    "Access to this resource (%s) is forbidden for guests." : "訪客無法存取此資源 (%s)。",
    ...
    "Convert to guest account" : "轉換為訪客帳號",
    "The account \"{userId}\" will be converted into a guest account. It keeps its login name and password but becomes a limited guest account, restricted to the apps allowed for guests." : "帳號「{userId}」將會轉換為訪客帳號。該帳號將保留原有的登入名稱和密碼，但會轉變為功能受限的訪客帳號，僅能使用允許訪客使用的應用程式。",
    "This is only possible for accounts that have never logged in. It cannot be undone automatically." : "此功能僅適用於從未登入過的帳號。此操作無法自動撤銷。",
    "Cancel" : "取消",
    "Converting account…" : "正在轉換帳號⋯⋯",
    "Convert to guest" : "轉換為訪客",
    "None" : "無",
    "Name" : "名稱",
    "Shared By" : "分享者：",
    "Shared At" : "分享時間：",
    "An error occurred while fetching the shares list" : "擷取分享清單時發生錯誤",
    "Guest accounts" : "訪客帳號",
    "Email" : "電子郵件",
    "User ID" : "使用者 ID",
    "Invited by" : "邀請者：",
    ...
    "An error occurred while converting the guest" : "轉換訪客時發生錯誤",
    ...
    "Invite guest" : "邀請訪客",
    "Default quota ({size})" : "預設配額 ({size})",
    "Unlimited" : "無限制",
    "Please enter a quota with a unit, for example \"500 MB\" or \"2 GB\"" : "請輸入包含單位的配額，例如「500 MB」或「2 GB」",
    "Error" : "錯誤",
    ...
    "Use a hash of the email as user ID for improved privacy" : "將電子郵件的雜湊值作為使用者 ID，以提升隱私保護",
    ...
    "No apps selected" : "未選取應用程式",
    "Edit allowlist" : "編輯允許清單",
    "Confirm allowlist" : "確認允許清單",
    "Reset allowlist" : "重設允許清單",
    "Default quota for new guest accounts" : "新訪客帳號的預設配額",
    "Add guest" : "新增訪客",
    ...
    "Account \"{userId}\" was converted into a guest account" : "帳號「{userId}」已轉換為訪客帳號"
},
"nplurals=1; plural=0;");
